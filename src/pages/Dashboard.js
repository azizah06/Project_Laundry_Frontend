            ...
            <div className="container" >
                <div className="row">
                    <div className=" col-lg-4 col-md-6">
                        <div className="card text-center bg-success text-white m-1">
                            <div className="card-body">
                                <h4 className="card-title">Data Member</h4>
                                <h2>{this.state.jmlMember}</h2>
                                <h6>Customer yang telah kami layani</h6>
                            </div>
                        </div>
                    </div>
                    <div className=" col-lg-4 col-md-6">
                        <div className="card text-center bg-info text-white m-1">
                            <div className="card-body">
                                <h4 className="card-title">Data paket</h4>
                                <h2>{this.state.jmlPaket}</h2>
                                <h6>Paket yg kami layani di laundry ini</h6>
                            </div>
                        </div>
                    </div>
                    <div className=" col-lg-4 col-md-6">
                        <div className="card text-center bg-dark text-white m-1">
                            <div className="card-body">
                                <h4 className="card-title">Data Transaksi</h4>
                                <h2>{this.state.jmlTransaksi}</h2>
                                <h6>Transaksi yg telah kami layani</h6>
                            </div>
                        </div>
                    </div>
